...
export const Tags: {[id: string]: TagData} = {
	...
	plutoniumuubl: {
		...
		'Basculin', 'Blacephalon', 'Blaziken', 'Charizard-Mega-X', 'Diancie-Mega', 'Gallade-Mega', 'Gardevoir-Mega', 'Greninja', 'Gyarados-Mega',
		'Inteleon', 'Latias-Mega', 'Latios-Mega', 'Manaphy', 'Noivern', 'Pinsir-Mega', 'Zeraora', 
